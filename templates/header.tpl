...
<tr valign="bottom">
    <td rowspan="2" width="401" valign="bottom"><a href="/"><img src="{$base_url}/image/header/ocua-logo-top-half.png" width="399" height="37" border="0" alt="Ottawa-Carleton Ultimate Association" /></a></td>
	<td></td>
</tr>
<tr>
...
<table id="secondary-menu" border="0" cellpadding="0" cellspacing="0" width="100%">
	<tr height="22">
		<td align="left" height="22" width="130" valign="top"><a href="/"><img src="{$base_url}/image/header/ocua-logo-bottom-half.png" width="130" height="22" border="0" alt="" /></a></td>
	</tr>
</table>
<!-- end header -->
<table width='100%'><tr>
