...
{/if}
	...
	<input type="text" maxlength="200" name="edit[name]" size="35" value="" /><div class="description">The full name of your team.  Text only, no HTML</div>

    <label for="edit[website]">Website</label>
	<input id="edit[website]" type="text" maxlength="200" name="edit[website]" size="35" value="" /><div class="description">Your team's website (optional)</div>

    <label for="edit[shirt_colour]">Shirt Colour</label>
	<input type="text" maxlength="200" name="edit[shirt_colour]" size="35" value="" /><div class="description">Shirt colour of your team.  If you don't have team shirts, pick 'light' or 'dark'</div>
