...
function feature_settings()
{
	...
	$group .= form_radios("Use Post-Nuke authentication", "edit[postnuke]", variable_get("postnuke", 0), array("Disabled", "Enabled"), "If enabled, Leaguerunner will use your Post-Nuke user database for user names, passwords and email addresses. Everything to do with passwords and logins will be hidden.");

	$group .= form_radios("Narrow display", "edit[narrow_display]", variable_get("narrow_display", 0), array("Disabled", "Enabled"), "If enabled, various displays will be adjusted for horizontal compactness. This is most useful when using Post-Nuke, as its left menu block eats up valuable real estate.");
